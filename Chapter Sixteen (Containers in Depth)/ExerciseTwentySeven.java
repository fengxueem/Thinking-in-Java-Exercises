...
4
*/
// Appearently, the CountedString still works as an index. But the hashcode it creates doesn't fullfill the needs
// to improve the speed of looking up, it only produces collisions for the ones with the same string inside.
// If you further change the equals() methond into what line37-38 shows, which neglects "id", you will find the HashMap
// class will not put five (CountedString, Integer) pairs inside instead only one shall be stored, since the map sees 
// no differences between CountedString objects used as the index at line46.
public class ExerciseTwentySeven {
  public static void main(String[] args) {
  	CountedString.main(args);
  }	
}