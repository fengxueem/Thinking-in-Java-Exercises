...
public class ExerciseTwenty {
	...
	public static void main(String[] args){
		...
		Set<String> words = new TreeSet<String>(new TextFile("ExerciseTwenty.java", "\\W+"));
    System.out.println(words);
   	Map<Character,Integer> vowelsCounter = new HashMap<Character,Integer>();
   	...
   	for (String word : words) {
    	...
    	for (Character c : word.toCharArray()) {
    		if (vowels.contains(c)) {
    			count++;
    			Integer temp = vowelsCounter.get(c);
    			vowelsCounter.put(c, temp == null? 1 : temp + 1);
    		}
    	}
    ...
    System.out.println("Details of num of vowels: " + vowelsCounter);
	}	
}